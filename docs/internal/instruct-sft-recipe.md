...
Each full-data launch still needs explicit approval. Fresh full runs must write to a fresh output directory; resume runs must find a valid latest checkpoint in the target directory.
